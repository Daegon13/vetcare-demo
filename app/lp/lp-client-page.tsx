...
import { Container, Badge, Card, CardContent, LinkButton } from "@/components/ui";
...
const SOLUTIONS = [
  {
    title: "Turnos",
    description: "Reservas online claras para reducir llamados y captar consultas 24/7."
  },
  {
    title: "Urgencias",
    description: "Evaluación guiada para priorizar casos y orientar al tutor en segundos."
  },
  {
    title: "Seguimiento y portal",
    description: "Historial y estado de la mascota en un solo lugar para fidelizar clientes."
  }
];
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-warm-100 py-10 dark:from-graphite-950 dark:to-graphite-900 sm:py-14">
      <Container className="grid gap-8 sm:gap-10">
        <section className="grid gap-4 text-center">
          <Badge className="mx-auto w-fit">Landing para campañas</Badge>
          <h1 className="text-3xl font-black tracking-tight sm:text-5xl">La forma más rápida de convertir anuncios en pacientes para tu veterinaria.</h1>
          <p className="mx-auto max-w-2xl text-sm text-black/65 dark:text-white/70 sm:text-lg">
            Activá turnos, urgencias y seguimiento digital con una implementación simple y enfocada en resultados.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <LinkButton href="#demo" variant="outline" onClick={onDemoClick}>
              Ver demo e implementación
            </LinkButton>
          </div>
        </section>

        <section className="grid gap-3" aria-label="Qué resuelve">
            ...
            {SOLUTIONS.map((item) => (
              <Card key={item.title}>
                <CardContent className="grid gap-2">
                  ...
                  <p className="text-sm text-black/65 dark:text-white/70">{item.description}</p>
                </CardContent>
              </Card>
            ))}
          </ul>
