...
const defaultTitle = `${BRAND.name} — Turnos, orientación, pedidos y seguimiento`;
const defaultDescription = `${BRAND.name} ofrece agenda online, orientación inicial, pedidos cotidianos y seguimiento para una atención veterinaria clara y cercana.`;
